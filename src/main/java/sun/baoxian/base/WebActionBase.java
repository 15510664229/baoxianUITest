...
import sun.baoxian.utils.XmlReadUtil;
import sun.baoxian.utils.YamlReadUtil;
...
public class WebActionBase  extends WebCaseBase {
    ...
    static By getBy (LocatorBase.ByType byType, LocatorBase locator)
    {
        switch(byType)
        {
            case id:
    ...
    public WebElement findElement(final LocatorBase locator) throws IOException
    {
        /**
         * 查找某个元素等待几秒
         */
