...
public class AiXinChildAction extends WebCaseBase {
    WebElementBase action = new WebElementBase();
    IdCardGenerator idcard=new IdCardGenerator();
    Mobile info=new Mobile();

    //超级玛丽牛保
    public void aixinChildTest() throws  Exception {
        homepage page = new homepage();
        YAiXinChildPage page1 = new YAiXinChildPage();
        AiXinChildPage page2=new AiXinChildPage();
...
//        init.setInsEml((info.getEmail(4, 8)).toString());
        ...
        action.selectByText(page.plat_goods_id(), "爱心--少儿");
        ...
        action.sleep(4);
        action.click(page1.insurance_period_25A());
        action.click(page1.pay_10Y());
        action.click(page1.pay_type_M());
