...
public class YSuperMaAction extends WebCaseBase {
    ...
    public void supermarieTest() throws  Exception {
        ...
        YsuperMaPage page1 = new YsuperMaPage();
        superMaPage page2=new superMaPage();
...
//        init.setBankMob(aplmobile);
        ...
        action.selectByText(page.plat_goods_id(), "超级玛丽--牛保");
        ...
        action.click(page1.quding());
        action.sleep(3);
        action.click(page1.baoer10());
        //action.executeJS("window.scrollBy(0,400);");
        action.sleep(2);
        //action.click(page1.insurance_period_999());
//        action.executeJS("window.scrollBy(0,400);");
//        action.sleep(2);
        action.executeJS("window.scrollBy(0,400);");
        action.sleep(3);
        action.click(page1.pay_20Y());
        action.click(page1.pay_type_S());
        action.click(page1.zhongdajibing());
...
//        action.click(page1.jiangao());
        ...
        action.sleep(2);
        //银行卡信息填写
        action.click(page1.bankcity());
        action.sleep(2);
        action.click(page1.quding());
        init.setBankCity(action.getText(page1.bankcitycont()));
        action.sleep(2);
...
//        action.sleep(7);
        ...
        String inscityu=action.getText(page1.citycont()).replaceAll("/*-", "");
        target.setInsCity(inscityu);
...
//        action.click(page2.insname());
        ...
        target.setBankCity(action.getText(page1.bankcitycont()));
...
//        init.setBankMob(aplmobile);
        ...
        action.selectByText(page.plat_goods_id(), "超级玛丽MAX3号");
        action.click(page.save());
        action.sleep(8);
        //切换frame
        action.switchToFrame(page.product_frame());
