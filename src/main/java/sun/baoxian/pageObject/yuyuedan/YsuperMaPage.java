...
public class YsuperMaPage extends WebActionBase {
...
* @throws IOException
*/
public  LocatorBase baoer25() throws IOException
 {
   LocatorBase locator=getLocator("baoer25");
   return locator;
 }
...
/***
* insurance_period_999
* @return
* @throws IOException
*/
public  LocatorBase insurance_period_999() throws IOException
 {
   LocatorBase locator=getLocator("insurance_period_999");
   return locator;
 }
...
* @throws IOException
*/
public  LocatorBase zhongdajibing() throws IOException
 {
   LocatorBase locator=getLocator("zhongdajibing");
   return locator;
 }
...
* @throws IOException
*/
public  LocatorBase bankcity() throws IOException
 {
   LocatorBase locator=getLocator("bankcity");
   return locator;
 }
