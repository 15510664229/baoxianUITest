...
import sun.baoxian.utils.pageObjectGenerate.GenerateAutoCodeForYml;//爱心人寿——听妈妈的话_对象库类
public class AiXinChildPage extends WebActionBase {
//用于eclipse工程内运行查找对象库文件路径
private String path="src/main/resources/pageObjectFiles/yml/";
 public   AiXinChildPage() {
//工程内读取对象库文件
	setXmlObjectPath(path+"/UILibrary-AiXinChild.yml");
getLocatorMap();
}
/***
* insure
