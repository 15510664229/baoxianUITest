...
public class XmlReadUtil {
            ...
            for (Iterator<?> i = root.elementIterator(); i.hasNext();) {
                ...
                if (page.attribute(0).getValue().equalsIgnoreCase(pageName)) {
                    ...
                    for (Iterator<?> l = page.elementIterator(); l.hasNext();) {
                        ...
                        // trim()去除字符串前后空格
                        LocatorBase temp = new LocatorBase(value.trim(), Integer.parseInt(timeOut), getByType(type),
                                locatorName.trim());
     ...
     * @param type
     */
    public static LocatorBase.ByType getByType(String type) {
    ...
    public static String getTestngParametersValue(String path, String ParametersName)
