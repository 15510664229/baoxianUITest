...
public class GenerateAutoCodeForXml {
        ...
        static  String path="src/main/resources/pageObjectFiles/xml/UILibrary.xml";
        public static void autoCode() throws Exception
        {
            ...
            for(Iterator<?> i=root.elementIterator();i.hasNext();)
            {
                ...
                //获取要写入的page所属的类名
                String pageClassName=pageNameArray[5].toString();
                //获取对象库包名
                String packageName=pageNameArray[0].toString()+"."+pageNameArray[1].toString()+"."+pageNameArray[2].toString()+"."+pageNameArray[3].toString()+"."+pageNameArray[4].toString();
                //--自动编写对象库代码（XXPage.java）开始--
                StringBuffer sb=new StringBuffer("package "+packageName+";\n");
                sb.append("import java.io.IOException;\n");
                sb.append("import java.io.InputStream;\n");
                sb.append("import com.testfan.ui.auto.base.web.WebActionBase;\n");
                sb.append("import com.testfan.ui.auto.base.LocatorBase;\n");
                sb.append("import com.testfan.ui.auto.utils.pageObjectGenerate.GenerateAutoCodeForXml;");
                ...
                sb.append("private String path=\"src/main/resources/pageObjectFiles/xml/UILibrary.xml\";\n");
                sb.append(" public   "
                        + pageClassName
                        + "() {\n");
